...
const NavBar = ({ isChecked, setIsChecked, darkModeValue, setDarkModeValue }) => {
    ...
    const handleCheckboxChange = (event) => {
        ...
        if (!event.target.checked === false) {
            setDarkModeValue('cmyk');
        } else {
            setDarkModeValue('dracula');
        }
    }
    ...
    return (
        <div data-theme={darkModeValue} className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-72">
                        ...
                        <li><Link to='/timos'>Timos Timer</Link></li>
                        <li><Link to='portfolio'>Portfolio</Link></li>
                        <li><Link to='/resumes'>Resumes</Link></li>
                        <li><Link to='/flaskoSQL'>flaskoSQL</Link></li>
                        <li><Link to='/about'>About</Link></li>
                        <li><a href={pdfURL} download={filename} >CV</a></li>
                    </ul>
                </div>
            </div>
            <div className="navbar-center">
                <Link to='/' className="btn btn-ghost normal-case text-xl">ACHRAF KHABAR</Link>
            </div>
            <div className="navbar-end">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href='https://github.com/Ashraf-Khabar/Portfolio' title="Source code ">
